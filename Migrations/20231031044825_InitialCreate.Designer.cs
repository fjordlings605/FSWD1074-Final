...
namespace burble_api.Migrations
{
    ...
    [Migration("20231031044825_InitialCreate")]
            ...
            modelBuilder.Entity("burble_api.Models.Burble", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TimeDate = new DateTime(2023, 10, 30, 23, 48, 25, 776, DateTimeKind.Local).AddTicks(4080),
                            Username = "Default01"
                        },
                        new
                        {
                            ...
                            TimeDate = new DateTime(2023, 10, 30, 23, 48, 25, 776, DateTimeKind.Local).AddTicks(4129),
                            Username = "Default02"
                        });
                });
